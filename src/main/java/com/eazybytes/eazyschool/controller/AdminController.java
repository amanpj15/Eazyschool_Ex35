...
/* And inside my classes.html I'm going to use this object and I'm going to tie 
 * this object to my HTML form using which my admin can create new classes & the 
 * same information can can come back to the controller layer and we can save that 
 * info eventually into the database.*/
